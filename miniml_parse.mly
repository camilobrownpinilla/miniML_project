...
%token LESSTHANEQ GREATERTHANEQ
%token CONCAT
%token IF THEN ELSE 
%token FUNCTION
%token RAISE
...
%left GREATERTHANEQ LESSTHANEQ
%left AND OR
%left EQUALS
%left PLUS MINUS
%left TIMES DIV EXP
%left CONCAT
%nonassoc NEG NOT SIN COS
...
expnoapp: INT                   { Num $1 }
        ...
        | exp LESSTHANEQ exp    { Binop(LessThanEq, $1, $3) }
        | exp GREATERTHANEQ exp { Binop(GreaterThanEq, $1, $3) }
